...
| 环境 | BASE_URL | 最终 URL |
|------|----------|----------|
| 本地开发 | 不设置 | http://localhost:3000/ |
| GitHub Pages | 不设置 | https://szqifeng.github.io/openclaw/ |
| 自定义域名 | `/` | https://trainlobster.com/ |
| 子目录部署 | `/docs/` | https://example.com/docs/ |
...
部署成功后，访问：
- 生产环境：https://szqifeng.github.io/openclaw/
