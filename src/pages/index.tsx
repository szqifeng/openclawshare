      ...
      <main>
        <section style={{...container, ...hero}} id="hero">
          <div style={heroContent}>
            <h1 style={heroTitle}>
              OpenClaw<br/>
              <span style={heroTitleAccent}>AI 自动化能力提升平台</span>
            </h1>
<p style={heroSubtitle}>
              从使用到原理再到二次开发，这里有你想知道的一切
            </p>
            <div style={heroButtons}>
              <Link to="/docs/openclaw/quick-install" style={btnPrimary}>快速开始</Link>
              <Link to="/docs/openclaw/quick-install" style={btnSecondary}>了解更多</Link>
              {showInstallBtn && (
                <button
...
<h3 style={cardTitle}>Start</h3>
                     <p style={cardDesc} className="card-desc">快速开始，5分钟上手，30分钟掌握核心概念</p>
                     <Link to="/docs/openclaw/quick-install" style={cardLink}><span className="card-link-full">快速开始</span><span className="card-link-icon">→</span></Link>
                   </Link>
<Link to="/docs/openclaw/plugin-dev" className="card" style={card}>
                    <svg style={svgIcon} viewBox="0 0 64 64" fill="none">
                     <defs>
                     ...
                     <circle cx="32" cy="32" r="28" fill="url(#plugGradient)" opacity="0.1">
                       <animate attributeName="r" values="28;32;28" dur="2.5s" repeatCount="indefinite"/>
                     </circle>
                     <rect x="16" y="24" width="32" height="16" rx="4" stroke="url(#plugGradient)" strokeWidth="2" fill="none">
                       <animate attributeName="x" values="16;14;16" dur="2s" repeatCount="indefinite"/>
                     </rect>
                     <rect x="20" y="28" width="24" height="8" rx="2" fill="url(#plugGradient)">
                       <animate attributeName="opacity" values="1;0.4;1" dur="1.5s" repeatCount="indefinite"/>
                     </rect>
                     <circle cx="48" cy="32" r="6" stroke="url(#plugGradient)" strokeWidth="2" fill="none">
                       <animate attributeName="r" values="6;8;6" dur="1s" repeatCount="indefinite"/>
                     </circle>
                     <circle cx="16" cy="32" r="6" stroke="url(#plugGradient)" strokeWidth="2" fill="none">
                       <animate attributeName="r" values="6;8;6" dur="1s" repeatCount="indefinite" begin="0.5s"/>
                     </circle>
                   </svg>
<h3 style={cardTitle}>插件市场</h3>
                     <p style={cardDesc} className="card-desc">插件系统，支持自定义扩展，轻松集成第三方服务</p>
                     <Link to="/plugins" style={cardLink}><span className="card-link-full">了解插件</span><span className="card-link-icon">→</span></Link>
                   </Link>
                   <Link to="/docs/openclaw/skills" className="card" style={card}>
                    <svg style={svgIcon} viewBox="0 0 64 64" fill="none">
                      <defs>
                    ...
                    <h3 style={cardTitle}>Skills</h3>
                     <p style={cardDesc} className="card-desc">技能集合，一键添加成熟技能，如发送邮件、数据处理等</p>
                     <Link to="/docs/openclaw/skills" style={cardLink}><span className="card-link-full">了解技能</span><span className="card-link-icon">→</span></Link>
                   </Link>
                   <Link to="/docs/openclaw/config-guide" className="card" style={card}>
                    <svg style={svgIcon} viewBox="0 0 64 64" fill="none">
                     <defs>
                     ...
                     <circle cx="32" cy="32" r="28" fill="url(#modelGradient)" opacity="0.1">
                       <animate attributeName="r" values="28;32;28" dur="3.5s" repeatCount="indefinite"/>
                     </circle>
                     <circle cx="32" cy="20" r="8" stroke="url(#modelGradient)" strokeWidth="2" fill="none">
                       <animate attributeName="cy" values="20;18;20" dur="2s" repeatCount="indefinite"/>
                     </circle>
                     <path d="M18 40Q32 32 46 40" stroke="url(#modelGradient)" strokeWidth="2" fill="none">
                       <animate attributeName="d" values="M18 40Q32 32 46 40;M18 38Q32 34 46 38;M18 40Q32 32 46 40" dur="1.5s" repeatCount="indefinite"/>
                     </path>
                     <circle cx="20" cy="24" r="2" fill="url(#modelGradient)">
                       <animate attributeName="opacity" values="1;0.3;1" dur="0.5s" repeatCount="indefinite"/>
                     </circle>
                     <circle cx="44" cy="24" r="2" fill="url(#modelGradient)">
                       <animate attributeName="opacity" values="1;0.3;1" dur="0.5s" repeatCount="indefinite" begin="0.25s"/>
                     </circle>
                     <rect x="26" y="44" width="12" height="2" rx="1" fill="url(#modelGradient)">
                       <animate attributeName="width" values="12;14;12" dur="1s" repeatCount="indefinite"/>
                     </rect>
                   </svg>
                   <h3 style={cardTitle}>Model</h3>
                    <p style={cardDesc} className="card-desc">支持多种大语言模型配置，如 DeepSeek、OpenAI、Claude 等</p>
                    <Link to="/docs/openclaw/config-guide" style={cardLink}><span className="card-link-full">配置模型</span><span className="card-link-icon">→</span></Link>
                  </Link>
               </div>
             </div>
           </section>
...
<section style={sectionBg} id="mobile-menu" className="mobile-menu-section">
            <div style={container}>
              ...
              <div style={mobileMenuGrid}>
                <Link to="/docs/openclaw/quick-install" style={mobileMenuItem}>
                  ...
                  <div>
                    <h3 style={mobileMenuTitle}>快速开始</h3>
                    <p style={mobileMenuDesc}>5分钟上手</p>
                  </div>
                </Link>
                <Link to="/docs/openclaw/config-guide" style={mobileMenuItem}>
                  <div style={mobileMenuIcon}>🤖</div>
                  <div>
                    <h3 style={mobileMenuTitle}>配置模型</h3>
                    <p style={mobileMenuDesc}>DeepSeek/Claude</p>
                  </div>
                </Link>
                <Link to="/plugins" style={mobileMenuItem}>
                  <div style={mobileMenuIcon}>🔌</div>
                  <div>
                    <h3 style={mobileMenuTitle}>插件开发</h3>
                    <p style={mobileMenuDesc}>扩展能力</p>
                  </div>
                </Link>
                <Link to="/docs/openclaw/skills" style={mobileMenuItem}>
                  <div style={mobileMenuIcon}>🎯</div>
                  <div>
                    <h3 style={mobileMenuTitle}>技能市场</h3>
                    <p style={mobileMenuDesc}>一键添加技能</p>
                  </div>
</Link>
              </div>
            </div>
         ...
         <section style={section} id="roadmap">
          <div style={container}>
            <h2 style={sectionTitle}>快速上手</h2>
            <div style={roadmap}>
               <div style={roadmapItem}>
                 <div style={roadmapIcon}>📥</div>
                 <h3 style={roadmapTitle}>下载安装</h3>
                 <p style={roadmapDesc} className="roadmap-desc">支持 Mac、Windows、Linux</p>
               </div>
               <div style={roadmapItem}>
                 <div style={roadmapIcon}>⚙️</div>
                 <h3 style={roadmapTitle}>配置模型</h3>
                 <p style={roadmapDesc} className="roadmap-desc">配置 DeepSeek 等模型</p>
               </div>
               <div style={roadmapItem}>
                 <div style={roadmapIcon}>🔌</div>
                 <h3 style={roadmapTitle}>集成飞书</h3>
                 <p style={roadmapDesc} className="roadmap-desc">配置飞书机器人</p>
               </div>
               <div style={roadmapItem}>
                 <div style={roadmapIcon}>🚀</div>
        ...
        <section style={sectionBg} id="scenarios">
          <div style={container}>
            <h2 style={sectionTitle}>应用场景</h2>
            <div style={scenarioGrid}>
               <div style={scenarioCard}>
                 <div style={scenarioIcon}>📱</div>
                 <h3 style={scenarioTitle}>飞书集成</h3>
                 <p style={scenarioDesc} className="scenario-desc">通过飞书机器人实现智能交互</p>
               </div>
               <div style={scenarioCard}>
                 <div style={scenarioIcon}>🔄</div>
                 <h3 style={scenarioTitle}>任务自动化</h3>
                 <p style={scenarioDesc} className="scenario-desc">自动化处理重复性工作</p>
               </div>
                <div style={scenarioCard}>
                  <div style={scenarioIcon}>💬</div>
                  <h3 style={scenarioTitle}>智能对话</h3>
                  <p style={scenarioDesc} className="scenario-desc">基于 AI 的智能问答服务</p>
                </div>
               <div style={scenarioCard}>
                 <div style={scenarioIcon}>🔌</div>
                 <h3 style={scenarioTitle}>插件扩展</h3>
                 <p style={scenarioDesc} className="scenario-desc">灵活扩展系统能力</p>
               </div>
            </div>
          </div>
        </section>
        ...
        <section style={section} id="resources">
          <div style={container}>
            <h2 style={sectionTitle}>相关资源</h2>
            <div style={resourceGrid}>
              <Link to="/docs/openclaw/quick-install" style={resourceCard}>
                <div style={resourceIcon}>🚀</div>
                <div style={resourceTitle}>快速入门</div>
              </Link>
              <Link to="/docs/openclaw/config-guide" style={resourceCard}>
                <div style={resourceIcon}>⚙️</div>
                <div style={resourceTitle}>配置指南</div>
              </Link>
              <Link to="/docs/openclaw/plugin-dev" style={resourceCard}>
                <div style={resourceIcon}>🔌</div>
                <div style={resourceTitle}>插件开发</div>
              </Link>
            </div>
          </div>
        </section>
